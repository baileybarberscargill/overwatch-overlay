//Define replicants
const TeamName = nodecg.Replicant('Team1Name');
const TeamColourP = nodecg.Replicant('Team1ColourP');
const TeamColourS = nodecg.Replicant('Team1ColourS');
const TeamLogo = nodecg.Replicant('Team1Logo');
